...
def run(credential: str, platform: str, project: str, model_id: str) -> None:
    ...
    if not project or not model_id:
        print("")
        print("[-] ERROR: Missing required command argument: /project:... or /model-id:...")
        print("    (Format: entity/project or just project. Model ID is artifact name)")
        print("")
        return
    ...
    # model_id is usually "name:version" or just "name" (latest)
